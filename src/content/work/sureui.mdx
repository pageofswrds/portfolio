...
<VideoPlayer
            width="100%"
            height="auto"
            videoUrl='https://schultzdavidg-portfolio.s3.us-west-1.amazonaws.com/images/dv/bar+chart_final.mp4'
             />
...
<Button variant="primary" className="mb-16" asChild>
    <Link href="https://www.figma.com/community/file/1357811212711130745/sureui-data-visualization" target="_blank">
        <span style={{ paddingRight: '0.5rem' }}>Try it out</span>
        <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ verticalAlign: '-0.125em' }} aria-hidden="true">
            <path d="M15 3h6v6" />
            <path d="M10 14 21 3" />
